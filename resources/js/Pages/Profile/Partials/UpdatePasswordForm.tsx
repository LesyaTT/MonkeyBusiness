...
export default function UpdatePasswordForm({ className = '' }: { className?: string }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-semibold text-white">Обновите пароль</h2>

                <p className="mt-1 text-sm text-back-light">
                    Убедитесь что ваш аккаунт использует длинный и надежный пароль чтобы оставаться в безопасности.
                </p>
            </header>
